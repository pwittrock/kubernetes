    ...
    $.widget("toc.tocify", {
        ...
        _generateToc: function() {
            ...
            firstElem.each(function(index) {
                ...
                // pwittroc - set if this is a category toc item in which case we want to display it differently.
        ...
        _nestElements: function(self, index) {
            ...
            // Set the category if this item should be a heading
            if (self.is("strong")) {
                category = "true"
            } else if (self.children("strong").length > 0) {
                category = "true"
            } else {
                category = "false"
            }
